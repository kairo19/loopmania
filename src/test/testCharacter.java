...
public class testCharacter {
    ...
    public void Test1(){
        ...
        LoopManiaWorldController controller = new LoopManiaWorldController(world, initialEntities);

        //initialize();

        //json = new JSONObject(new JSONTokener(new FileReader("Worlds/" + "basic_world_with_player.json")));
        //List<Pair<Integer, Integer>> orderedPath = loadPathTiles(json.getJSONObject("path"), 8, 16);
        loader = new LoopManiaWorldLoader();
        d = loader.load();

        //LoopManiaWorld d = new LoopManiaWorld(8, 16, orderedPath);
        //assertEquals(d.getWidth(), 8);
