...
public class PlaceableOnNonPathTest {

    @Test
    public void PlaceableOnNonPathCheckTest() {
        LoopManiaWorld world = initialise();
        PlacableBehaviour adj = new PlacableOnNonPath();
    
        assertEquals(adj.placable(1, 1, world.getOrderedPath()), false);
        assertEquals(adj.placable(4, 1, world.getOrderedPath()), true);     
    }
